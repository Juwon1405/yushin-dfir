...
- Load playbook YAML from `dart-playbook/`
...
- Security boundaries (those live in `dart-mcp` + OS mount)
- Tool execution (delegated to `dart-mcp`)
- Correlation logic (delegated to `dart-corr`)
