...
60 read-only MCP tools. Zero destructive operations possible.
EOF
```
...
```
[ok] MCP surface verified: 35 native + 25 SIFT adapters = 60 tools
```
...
echo ""
echo "  60 read-only MCP tools  (35 native + 25 SIFT adapters)"
